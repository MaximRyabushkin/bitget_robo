...
**RU:**
Рейндж-бар представляет собой фиксированный ценовой диапазон, — и по сути является бином гистограммы. А выбранный сегмент рыночного движения может рассматриваться как статистическая выборка: распределением объёма по равным ценовым шагам.

В качестве физической аналогии, объём × диапазон цены = работа. Рейндж-бары нормируют расстояние, поэтому объём становится сопоставимым между барами. Таким образом, мы получаем мера рыночного усилия на единицу ценового движения.
